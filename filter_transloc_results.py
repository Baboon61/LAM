### A script allowing to filter TranslocPipeline results calling the TranslocFilter.pl function on the metadata.txt file
...
def usage():
	print('Usage:')
	print('\tpython '+sys.argv[0]+' -f <metadata.txt> -d <results directory> -m <mark> -g<genome name> [-n <marks input> --unaligned <value> --baitonly <value> --uncut <value> --misprimed <value> --freqcut <value> --largegap <value> --mapqual <value> --breaksite <value> --sequential <value> --repeatseq <value> --duplicate <value>]')
	...
	print("INFO : To not use a filter just don't put it in options")
...
def main(argv):
	...
	try:
		opts, args = getopt.getopt(sys.argv[1:], 'f:d:m:g:n:', ['metadata=', 'directory=', 'mark=', 'genome=', 'inputMark=', 'unaligned=', 'baitonly=', 'uncut=', 'misprimed=', 'freqcut=', 'largegap=', 'mapqual=', 'breaksite=', 'sequential=', 'repeatseq=', 'duplicate=', 'help'])
...
###CREATE THE COMMAND LINE
				command_line = "TranslocFilter.pl "+directory_path+i+"/"+i+file_input_extension+" "+directory_path+i+"/"+i+file_output_extension+" --filters "+"'"+options_line[1:]+"'"
				print(command_line)
